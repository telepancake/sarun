...
// is nothing to pre-batch). Each lookup walks one fnv-picked title
// shard directly; dynamic writer-side re-sharding bounds the physical
// size of that unit and avoids a whole-dictionary request cache.
#[cfg(feature = "serve")]
