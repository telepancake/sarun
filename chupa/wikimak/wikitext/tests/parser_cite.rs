...
#[test]
fn named_ref_reuse_accepts_doubled_quoted_tag_attribute() {
    // The Russian Efn template passes a quoted name through #tag, producing
    // name=""withunrecog"" in the expanded ref tag.  It is still one named
    // reference: the empty-body occurrence must reuse the definition.
    assert_eq!(
        render_inner(
            "A<ref group=\"lower-alpha\" name=\"\"withunrecog\"\">Definition</ref> \
             B<ref group=\"lower-alpha\" name=\"\"withunrecog\"\"></ref>\n\
             <references group=\"lower-alpha\"/>"
        ),
        "<p>A<sup class=\"reference\" id=\"cite_ref-lower-alpha-1-0\">\
         <a href=\"#cite_note-lower-alpha-1\">[lower-alpha 1]</a></sup> \
         B<sup class=\"reference\" id=\"cite_ref-lower-alpha-1-1\">\
         <a href=\"#cite_note-lower-alpha-1\">[lower-alpha 1]</a></sup></p>\
         <ol class=\"references\">\
         <li id=\"cite_note-lower-alpha-1\">\
         <span class=\"mw-cite-backlink\">^ \
         <a href=\"#cite_ref-lower-alpha-1-0\">a</a> \
         <a href=\"#cite_ref-lower-alpha-1-1\">b</a></span> \
         <span class=\"reference-text\">Definition</span></li></ol>"
    );
}
...
fn nested_ref_inside_ref_is_rendered_and_does_not_recurse_forever() {
    ...
    assert!(
        ...
        "outer close consumed before article text: {out}"
    );
}
